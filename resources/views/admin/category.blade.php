...
<body class="text-gray-800 font-inter bgicons">
    ...
    @section('admin-content')
        <h1 class="text-center text-5xl text-orange-500 font-semibold mt-6">Category Manage</h1>
                ...
                <table class="min-w-full bg-gray-700 bg-opacity-30 border border-gray-800">
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b border-white">Image</th>
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b border-white text-center">
                                    <img src="{{ $category->image ? asset('storage/' . $category->image) : asset('images/default-image.jpg') }}"
                                        alt="{{ $category->name }}" class="w-10 h-10 rounded-full mx-auto">
                                </td>
                                <td class="py-2 px-4 border-b border-white text-center">{{ $category->name }}</td>
                                <td class="py-2 px-4 border-b border-white text-center">
