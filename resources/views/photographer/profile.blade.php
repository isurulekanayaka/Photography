            ...
            <div class="md:mx-20 lg:mx-36 mx-5 p-6 bg-gray-100 rounded-lg mt-8 space-y-6">
                ...
                <div class="flex">
                    ...
                    <div class="pl-4 w-full">
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <input type="text" id="full_name" name="full_name" class="w-full p-2 border border-gray-300 rounded"
                ...
                <div class="flex gap-5 mb-4">
                    ...
                    <div class="w-1/2">
                        ...
                        <input type="text" id="contact_number" name="contact_number" class="w-full p-2 border border-gray-300 rounded"
                    ...
                    <div class="w-1/2">
                        ...
                        <input type="email" id="contact_email" name="contact_email" class="w-full p-2 border border-gray-300 rounded"
                               value="{{ $user->email ? $user->email : '' }}" placeholder="Enter your email">
                    </div>
                </div>
                ...
                <div class="flex gap-5 mb-4">
                    ...
                    <div class="w-1/2">
                        ...
                        <input type="text" id="experience" name="experience" class="w-full p-2 border border-gray-300 rounded"
                    ...
                    <div class="w-1/2">
                        ...
                        <input type="url" id="website" name="website" class="w-full p-2 border border-gray-300 rounded"
                ...
                <div class="flex gap-5 mb-4">
                    ...
                    <div class="w-1/2">
                        ...
                        <input type="text" id="address_area" name="address_area" class="w-full p-2 border border-gray-300 rounded"
                    ...
                    <div class="w-1/2">
                        ...
                        <input type="text" id="address_city" name="address_city" class="w-full p-2 border border-gray-300 rounded"
                ...
                <div class="flex gap-5 mb-4">
                    ...
                    <div class="w-1/2">
                        ...
                        <input type="password" id="old_password" name="old_password" class="w-full p-2 border border-gray-300 rounded"
                               placeholder="Enter your old password">
                    </div>
                    <!-- New Password Input -->
                    <div class="w-1/2">
                        <label class="block text-gray-700 font-semibold mb-2" for="new_password">New Password</label>
                        <input type="password" id="new_password" name="new_password" class="w-full p-2 border border-gray-300 rounded"
